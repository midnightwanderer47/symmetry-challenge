...
_Note: You might take the third value as a hint to add more functionality and prototypes we did not suggest..._
...
After having read this tutorial, you will be ready to use the mock use_cases you created in _2.1_ to form a great set of logical cubits so you can present the information to the user with the best performance and responsiveness.
